...
public class Locker : MonoBehaviour
{
    ...
    [SerializeField] GameObject magicItemPrefab; // 마법 슬롯 아이템 프리팹
    Collider2D coll;
        ...
        if (PlayerManager.Instance.hasGems[priceType] > price)
        {
            ...
            switch (randomType)
            {
                ...
                case 0:
                    ...
                    // 슬롯 아이템 만들기
                    dropObj = LeanPool.Spawn(magicItemPrefab, transform.position, Quaternion.identity, SystemManager.Instance.itemPool); ;
