...
public class HotBlade : MonoBehaviour
{
    ...
    IEnumerator Init()
    {
        ...
        // 디버프 초기화
        magicHolder.burnTime = magicHolder.duration;

        // 톱날 회전
        transform.DOLocalRotate(Vector3.forward * 360f, 1f, RotateMode.LocalAxisAdd)
        .SetEase(Ease.Linear)
        ...
        // 휠 사이즈만큼 명중률 낮추기
        magicHolder.targetPos += (Vector3)Random.insideUnitCircle.normalized * magicHolder.scale;
        ...
        float durationCount = magicHolder.duration;
