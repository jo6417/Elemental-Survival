...
public class EnemyHitBox : MonoBehaviour
{
    ...
    private void OnParticleCollision(GameObject other)
    {
        ...
        {
            enemyManager.Hit(other.gameObject);
    ...
    //         if (!enemyManager.IsGhost && magicHolder.targetType != MagicHolder.Target.Enemy && magicHolder.targetType != MagicHolder.Target.Both)
    //             yield break;

    //         // 고스트일때, 목표가 플레이어가 아니면 리턴
    //         if (enemyManager.IsGhost && magicHolder.targetType != MagicHolder.Target.Player && magicHolder.targetType != MagicHolder.Target.Both)
    //             yield break;
